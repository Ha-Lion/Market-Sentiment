...
function psdCreateAdvertiseBanner(){
  // Donation banner is now rendered by site-nav.js as part of the shared ribbon.
  // Keep this function as a no-op so older calls do not create a duplicate floating banner.
}
...
function psdApplyCompactRibbonLayout(){
  /* XX LAB: ribbon layout belongs exclusively to xx-ribbon-lab.css. */
}

  function psdNormalizeTopNavIcons(){
  /* XX LAB: ribbon labels/icons belong to xx-site-nav-lab.js + xx-ribbon-lab.css. */
}

  function psdEnsureMarketChartsNavLink(){
  /* XX LAB: navigation structure belongs exclusively to xx-site-nav-lab.js. */
}
...
function psdEnhanceSocialLinks(){
  /* XX LAB: ribbon social controls belong exclusively to xx-site-nav-lab.js. */
}
...
/* ==================================================
   XX LAB — VOTING WIDGET VISIBILITY GUARD
   Voting owns only voting. It does NOT alter the ribbon.
   ================================================== */
